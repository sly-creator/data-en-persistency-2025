...
public class TestOvchipkaart {
    ...
    public static void main(String[] args) {
        try (Connection conn = DriverManager.getConnection(
            ...
            OVChipkaartDAO ovdao = new OVChipkaartDAOPsql(conn,adao);
            ...
            OV_Chipkaart k1 = new OV_Chipkaart(780000001, LocalDate.now().plusYears(1), 2, new BigDecimal("25.00"), r);
            System.out.println("[save kaart1] -> " + ovdao.save(k1));

            OV_Chipkaart k2 = new OV_Chipkaart(780000002, LocalDate.now().plusMonths(6), 1,
                    new BigDecimal("10.50"), r);
            ...
            // Test UPDATE
            k1.setKlasse(1);
            k1.setSaldo(new BigDecimal("42.35"));
